...
INITIAL_LEARNING_RATE = FLAGS.LEARNING_RATE_DECAY_FACTOR  # Initial learning rate.
...
def inference(images):
    ...
    if FLAGS.model_version == 0:
        inference_model = inference_v0
    elif FLAGS.model_version == 1:
        inference_model = inference_v1
    elif FLAGS.model_version == 2:
        inference_model = inference_v2
    else:
        inference_model = inference_v1

    return inference_model(images)
